		...
		<div>
			<table class="form-table">
				...
				<tr valign="top" class="alternate">
					...
					<td><textarea id="styled" name="as_facebook_pg_reco_appid"
							cols="18" rows="1"><?php echo get_option('as_facebook_pg_reco_appid'); ?></textarea>
                    &nbsp;<?=$fb_recco?>
                    <br> <a
						href="#"
						target="_blank">How to create?</a></td>
				</tr>

				<tr valign="top">
					<th scope="row" style="width: 29%;"><label>Enter your read time</label></th>
					<td><textarea id="styled" name="as_facebook_pg_reco_readtime"
							cols="18" rows="1"><?php echo get_option('as_facebook_pg_reco_readtime'); ?></textarea>
                    &nbsp;<?=$fb_readtime?>
                </td>
				</tr>
				<tr valign="top" class="alternate">
					<th scope="row" style="width: 29%;"><label>Verb to Display?</label></th>
					<td><textarea id="styled" name="as_facebook_pg_reco_verb"
							cols="18" rows="1"><?php echo get_option('as_facebook_pg_reco_verb'); ?></textarea>
						i.e like/recommend</td>
				</tr>
				<tr valign="top">
					<th scope="row" style="width: 29%;"><label>Side?</label></th>
					<td><textarea id="styled" name="as_facebook_pg_reco_side"
							cols="18" rows="1"><?php echo get_option('as_facebook_pg_reco_side'); ?></textarea>
						i.e left/right</td>
				</tr>
				<tr valign="top" class="alternate">
					<th scope="row"><label>Site Domain?</label></th>
					<td><textarea id="styled" name="as_facebook_pg_reco_domain"
							cols="18" rows="1"><?php echo get_option('as_facebook_pg_reco_domain'); ?></textarea>
						i.e. http://medust.com</td>
				</tr>
